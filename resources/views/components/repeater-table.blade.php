            ...
            <table class="w-full">
                <thead @class([
                    ...
                    <tr class="text-sm md:divide-x md:rtl:divide-x-reverse md:divide-gray-300 dark:md:divide-gray-700">
                        ...
                        @endforeach
                        @if ($hasActions)
                            <th class="w-px p-2 filament-table-repeater-header-column bg-gray-200/50 dark:bg-gray-900/60 ltr:rounded-tr-xl rtl:rounded-tl-xl">
                ...
                >
                    ...
                    @else
                        ...
                        >
                            <td colspan="{{ count($headers) + intval($hasActions) }}" class="w-px p-4 italic text-center filament-table-repeater-column">
